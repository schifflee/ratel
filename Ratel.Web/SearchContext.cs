...
namespace Ratel.Web
{
    ...
    internal class ElementFinder : SearchContext<IWebElement>
    {
        ...
        public override string Description => $"Find element '{Name}' by ({_context}).FindElement({_locator})";
    ...
    internal class ElementsFinder : SearchContext<ReadOnlyCollection<IWebElement>>
    {
        ...
        public override string Description => $"Find elements '{Name}' by ({_context}).FindElements({_locator})";
    ...
    internal class ElementFinderFromCollectionByCondition : SearchContext<IWebElement>
    {
        ...
        public override string Description => $"Find element '{Name}' by ({_collection}).FindElement(by condition: {_conditionDescription})'";
    ...
    internal class ElementsFinderFromCollectionByCondition : SearchContext<ReadOnlyCollection<IWebElement>>
    {
        ...
        public override string Description => $"Find elements '{Name}' by ({_collection}).FindElements(by condition: {_conditionDescription})'";
